    ...
    <Card className="sticky top-6 shadow-lg border-l bg-white animate-in slide-in-from-right duration-300">
      ...
      <div className="p-4 space-y-4">
        <div>
          ...
          <p className="text-sm text-slate-600 leading-relaxed">{document.folderPath}</p>
        </div>
        ...
        <div className="space-y-2 pt-4 border-t border-slate-100">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium text-slate-900">{document.createdBy.displayName}</span>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="text-slate-500">Last updated</span>
            <span className="text-slate-900">{formatRelativeTime(document.updatedAt)}</span>
          </div>
          <div className="flex items-center justify-between text-sm">
